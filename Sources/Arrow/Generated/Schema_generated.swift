...
public enum org_apache_arrow_flatbuf_Type_: UInt8, UnionEnum {
  ...
  public static var max: org_apache_arrow_flatbuf_Type_ { return .largelistview }
...
public struct org_apache_arrow_flatbuf_ListView: FlatBufferObject, Verifiable {
  ...
  public static func startListView(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 0) }
  public static func endListView(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
...
///  extremely large data values.
public struct org_apache_arrow_flatbuf_LargeListView: FlatBufferObject, Verifiable {
  ...
  public static func startLargeListView(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 0) }
  public static func endLargeListView(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
...
public struct org_apache_arrow_flatbuf_Map: FlatBufferObject, Verifiable {
  ...
  public var keysSorted: Bool { let o = _accessor.offset(VTOFFSET.keysSorted.v); return o == 0 ? false : _accessor.readBuffer(of: Bool.self, at: o) }
...
public struct org_apache_arrow_flatbuf_Int: FlatBufferObject, Verifiable {
  ...
  public var isSigned: Bool { let o = _accessor.offset(VTOFFSET.isSigned.v); return o == 0 ? false : _accessor.readBuffer(of: Bool.self, at: o) }
...
public struct org_apache_arrow_flatbuf_Utf8View: FlatBufferObject, Verifiable {
  ...
  public static func startUtf8View(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 0) }
  public static func endUtf8View(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
...
///  Since it uses a variable number of data buffers, each Field with this type
///  must have a corresponding entry in `variadicBufferCounts`.
public struct org_apache_arrow_flatbuf_BinaryView: FlatBufferObject, Verifiable {
  ...
  public static func startBinaryView(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 0) }
  public static func endBinaryView(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
...
public struct org_apache_arrow_flatbuf_DictionaryEncoding: FlatBufferObject, Verifiable {
  ...
  public var isOrdered: Bool { let o = _accessor.offset(VTOFFSET.isOrdered.v); return o == 0 ? false : _accessor.readBuffer(of: Bool.self, at: o) }
...
public struct org_apache_arrow_flatbuf_Field: FlatBufferObject, Verifiable {
  ...
  public var nullable: Bool { let o = _accessor.offset(VTOFFSET.nullable.v); return o == 0 ? false : _accessor.readBuffer(of: Bool.self, at: o) }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(unionKey: VTOFFSET.typeType.p, unionField: VTOFFSET.type.p, unionKeyName: "typeType", fieldName: "type", required: false, completion: { (verifier, key: org_apache_arrow_flatbuf_Type_, pos) in
      ...
      case .binaryview:
        try ForwardOffset<org_apache_arrow_flatbuf_BinaryView>.verify(&verifier, at: pos, of: org_apache_arrow_flatbuf_BinaryView.self)
      case .utf8view:
        try ForwardOffset<org_apache_arrow_flatbuf_Utf8View>.verify(&verifier, at: pos, of: org_apache_arrow_flatbuf_Utf8View.self)
      case .listview:
        try ForwardOffset<org_apache_arrow_flatbuf_ListView>.verify(&verifier, at: pos, of: org_apache_arrow_flatbuf_ListView.self)
      case .largelistview:
        try ForwardOffset<org_apache_arrow_flatbuf_LargeListView>.verify(&verifier, at: pos, of: org_apache_arrow_flatbuf_LargeListView.self)
      }
    })
