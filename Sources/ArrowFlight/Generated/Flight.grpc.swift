...
internal protocol Arrow_Flight_Protocol_FlightServiceClientProtocol: GRPCClient {
  ...
  func pollFlightInfo(
    _ request: Arrow_Flight_Protocol_FlightDescriptor,
    callOptions: CallOptions?
  ) -> UnaryCall<Arrow_Flight_Protocol_FlightDescriptor, Arrow_Flight_Protocol_PollInfo>
...
extension Arrow_Flight_Protocol_FlightServiceClientProtocol {
  ...
  ///
  /// - Parameters:
  ///   - request: Request to send to PollFlightInfo.
  ///   - callOptions: Call options.
  /// - Returns: A `UnaryCall` with futures for the metadata, status and response.
  internal func pollFlightInfo(
    _ request: Arrow_Flight_Protocol_FlightDescriptor,
    callOptions: CallOptions? = nil
  ) -> UnaryCall<Arrow_Flight_Protocol_FlightDescriptor, Arrow_Flight_Protocol_PollInfo> {
    return self.makeUnaryCall(
      path: Arrow_Flight_Protocol_FlightServiceClientMetadata.Methods.pollFlightInfo.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
      interceptors: self.interceptors?.makePollFlightInfoInterceptors() ?? []
    )
  }
...
internal protocol Arrow_Flight_Protocol_FlightServiceAsyncClientProtocol: GRPCClient {
  ...
  func makePollFlightInfoCall(
    _ request: Arrow_Flight_Protocol_FlightDescriptor,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Arrow_Flight_Protocol_FlightDescriptor, Arrow_Flight_Protocol_PollInfo>
...
extension Arrow_Flight_Protocol_FlightServiceAsyncClientProtocol {
  ...
  internal func makePollFlightInfoCall(
    _ request: Arrow_Flight_Protocol_FlightDescriptor,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Arrow_Flight_Protocol_FlightDescriptor, Arrow_Flight_Protocol_PollInfo> {
    return self.makeAsyncUnaryCall(
...
internal protocol Arrow_Flight_Protocol_FlightServiceClientInterceptorFactoryProtocol: Sendable {
  ...
  /// - Returns: Interceptors to use when invoking 'pollFlightInfo'.
  func makePollFlightInfoInterceptors() -> [ClientInterceptor<Arrow_Flight_Protocol_FlightDescriptor, Arrow_Flight_Protocol_PollInfo>]
...
internal enum Arrow_Flight_Protocol_FlightServiceClientMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    ...
    methods: [
      ...
      Arrow_Flight_Protocol_FlightServiceClientMetadata.Methods.pollFlightInfo,
  ...
  internal enum Methods {
    ...
    internal static let pollFlightInfo = GRPCMethodDescriptor(
      name: "PollFlightInfo",
...
internal protocol Arrow_Flight_Protocol_FlightServiceProvider: CallHandlerProvider {
  ...
  /// A client may use the CancelFlightInfo action with
  /// PollInfo.info to cancel the running query.
  func pollFlightInfo(request: Arrow_Flight_Protocol_FlightDescriptor, context: StatusOnlyCallContext) -> EventLoopFuture<Arrow_Flight_Protocol_PollInfo>
  ...
  internal func handle(
    ...
    case "PollFlightInfo":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Arrow_Flight_Protocol_FlightDescriptor>(),
        responseSerializer: ProtobufSerializer<Arrow_Flight_Protocol_PollInfo>(),
        interceptors: self.interceptors?.makePollFlightInfoInterceptors() ?? [],
        userFunction: self.pollFlightInfo(request:context:)
      )
  ...
  internal func handle(
    ...
    case "PollFlightInfo":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Arrow_Flight_Protocol_PollInfo>(),
        interceptors: self.interceptors?.makePollFlightInfoInterceptors() ?? [],
        wrapping: { try await self.pollFlightInfo(request: $0, context: $1) }
      )
...
internal protocol Arrow_Flight_Protocol_FlightServiceServerInterceptorFactoryProtocol: Sendable {
  ...
  /// - Returns: Interceptors to use when handling 'pollFlightInfo'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makePollFlightInfoInterceptors() -> [ServerInterceptor<Arrow_Flight_Protocol_FlightDescriptor, Arrow_Flight_Protocol_PollInfo>]
...
internal enum Arrow_Flight_Protocol_FlightServiceServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    ...
    methods: [
      ...
      Arrow_Flight_Protocol_FlightServiceServerMetadata.Methods.pollFlightInfo,
