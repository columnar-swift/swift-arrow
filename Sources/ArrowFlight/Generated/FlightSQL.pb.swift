...
enum Arrow_Flight_Protocol_Sql_SqlInfo: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  /// Retrieves a boolean value indicating whether the Flight SQL Server supports executing
  /// bulk ingestion.
  case flightSqlServerBulkIngestion // = 10
  ...
  case flightSqlServerIngestTransactionsSupported // = 11
  ...
  init?(rawValue: Int) {
    ...
    case 10: self = .flightSqlServerBulkIngestion
    case 11: self = .flightSqlServerIngestTransactionsSupported
  ...
  var rawValue: Int {
    ...
    case .flightSqlServerBulkIngestion: return 10
    case .flightSqlServerIngestTransactionsSupported: return 11
  ...
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlInfo] = [
    .flightSqlServerName,
...
enum Arrow_Flight_Protocol_Sql_SqlSupportedTransaction: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlSupportedTransaction] = [
    .none,
    .transaction,
    .savepoint,
  ]
...
enum Arrow_Flight_Protocol_Sql_SqlSupportedCaseSensitivity: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlSupportedCaseSensitivity] = [
...
enum Arrow_Flight_Protocol_Sql_SqlNullOrdering: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlNullOrdering] = [
    .sqlNullsSortedHigh,
    .sqlNullsSortedLow,
...
enum Arrow_Flight_Protocol_Sql_SupportedSqlGrammar: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SupportedSqlGrammar] = [
    .sqlMinimumGrammar,
    .sqlCoreGrammar,
    .sqlExtendedGrammar,
  ]
...
enum Arrow_Flight_Protocol_Sql_SupportedAnsi92SqlGrammarLevel: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SupportedAnsi92SqlGrammarLevel] = [
    .ansi92EntrySql,
...
enum Arrow_Flight_Protocol_Sql_SqlOuterJoinsSupportLevel: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlOuterJoinsSupportLevel] = [
    .sqlJoinsUnsupported,
...
enum Arrow_Flight_Protocol_Sql_SqlSupportedGroupBy: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlSupportedGroupBy] = [
    .sqlGroupByUnrelated,
...
enum Arrow_Flight_Protocol_Sql_SqlSupportedElementActions: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlSupportedElementActions] = [
...
enum Arrow_Flight_Protocol_Sql_SqlSupportedPositionedCommands: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlSupportedPositionedCommands] = [
    .sqlPositionedDelete,
    .sqlPositionedUpdate,
  ]
...
enum Arrow_Flight_Protocol_Sql_SqlSupportedSubqueries: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlSupportedSubqueries] = [
...
enum Arrow_Flight_Protocol_Sql_SqlSupportedUnions: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case sqlUnion // = 0
  case sqlUnionAll // = 1
  case UNRECOGNIZED(Int)
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlSupportedUnions] = [
    .sqlUnion,
    .sqlUnionAll,
  ]
...
enum Arrow_Flight_Protocol_Sql_SqlTransactionIsolationLevel: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlTransactionIsolationLevel] = [
    .sqlTransactionNone,
...
enum Arrow_Flight_Protocol_Sql_SqlSupportedTransactions: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlSupportedTransactions] = [
...
enum Arrow_Flight_Protocol_Sql_SqlSupportedResultSetType: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlSupportedResultSetType] = [
...
enum Arrow_Flight_Protocol_Sql_SqlSupportedResultSetConcurrency: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlSupportedResultSetConcurrency] = [
...
enum Arrow_Flight_Protocol_Sql_SqlSupportsConvert: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_SqlSupportsConvert] = [
    .sqlConvertBigint,
    .sqlConvertBinary,
    .sqlConvertBit,
    .sqlConvertChar,
...
enum Arrow_Flight_Protocol_Sql_XdbcDataType: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_XdbcDataType] = [
    .xdbcUnknownType,
    .xdbcChar,
    .xdbcNumeric,
    .xdbcDecimal,
...
enum Arrow_Flight_Protocol_Sql_XdbcDatetimeSubcode: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_XdbcDatetimeSubcode] = [
    .xdbcSubcodeUnknown,
    .xdbcSubcodeYear,
    .xdbcSubcodeTime,
...
enum Arrow_Flight_Protocol_Sql_Nullable: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_Nullable] = [
    .nullabilityNoNulls,
    .nullabilityNullable,
    .nullabilityUnknown,
  ]
...
enum Arrow_Flight_Protocol_Sql_Searchable: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_Searchable] = [
    .none,
    .char,
    .basic,
    .full,
...
enum Arrow_Flight_Protocol_Sql_UpdateDeleteRules: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case cascade // = 0
  case restrict // = 1
  case setNull // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Arrow_Flight_Protocol_Sql_UpdateDeleteRules] = [
    .cascade,
    .restrict,
    .setNull,
    .noAction,
...
struct Arrow_Flight_Protocol_Sql_CommandGetSqlInfo: Sendable {
...
struct Arrow_Flight_Protocol_Sql_CommandGetXdbcTypeInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_CommandGetCatalogs: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_CommandGetDbSchemas: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_CommandGetTables: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_CommandGetTableTypes: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_CommandGetPrimaryKeys: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_CommandGetExportedKeys: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///    - 3 = NO ACTION
///    - 4 = SET DEFAULT
struct Arrow_Flight_Protocol_Sql_CommandGetImportedKeys: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///    - 3 = NO ACTION
///    - 4 = SET DEFAULT
struct Arrow_Flight_Protocol_Sql_CommandGetCrossReference: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_ActionCreatePreparedStatementRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_SubstraitPlan: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_ActionCreatePreparedSubstraitPlanRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_ActionCreatePreparedStatementResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_ActionClosePreparedStatementRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_ActionBeginTransactionRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_ActionBeginSavepointRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///
/// The result should be wrapped in a google.protobuf.Any message.
struct Arrow_Flight_Protocol_Sql_ActionBeginTransactionResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///
/// The result should be wrapped in a google.protobuf.Any message.
struct Arrow_Flight_Protocol_Sql_ActionBeginSavepointResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_ActionEndTransactionRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum EndTransaction: SwiftProtobuf.Enum, Swift.CaseIterable {
    typealias RawValue = Int
    case unspecified // = 0
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    static let allCases: [Arrow_Flight_Protocol_Sql_ActionEndTransactionRequest.EndTransaction] = [
      .unspecified,
      .commit,
      .rollback,
    ]
...
struct Arrow_Flight_Protocol_Sql_ActionEndSavepointRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum EndSavepoint: SwiftProtobuf.Enum, Swift.CaseIterable {
    typealias RawValue = Int
    case unspecified // = 0
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    static let allCases: [Arrow_Flight_Protocol_Sql_ActionEndSavepointRequest.EndSavepoint] = [
      .unspecified,
      .release,
      .rollback,
    ]
...
struct Arrow_Flight_Protocol_Sql_CommandStatementQuery: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_CommandStatementSubstraitPlan: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_TicketStatementQuery: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_CommandPreparedStatementQuery: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_CommandStatementUpdate: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_CommandPreparedStatementUpdate: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_CommandStatementIngest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The behavior for handling the table definition.
  var tableDefinitionOptions: Arrow_Flight_Protocol_Sql_CommandStatementIngest.TableDefinitionOptions {
    get {return _tableDefinitionOptions ?? Arrow_Flight_Protocol_Sql_CommandStatementIngest.TableDefinitionOptions()}
    set {_tableDefinitionOptions = newValue}
  }
  /// Returns true if `tableDefinitionOptions` has been explicitly set.
  var hasTableDefinitionOptions: Bool {return self._tableDefinitionOptions != nil}
  /// Clears the value of `tableDefinitionOptions`. Subsequent reads from it will return its default value.
  mutating func clearTableDefinitionOptions() {self._tableDefinitionOptions = nil}
  ...
  struct TableDefinitionOptions: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    var ifNotExist: Arrow_Flight_Protocol_Sql_CommandStatementIngest.TableDefinitionOptions.TableNotExistOption = .unspecified

    var ifExists: Arrow_Flight_Protocol_Sql_CommandStatementIngest.TableDefinitionOptions.TableExistsOption = .unspecified

    var unknownFields = SwiftProtobuf.UnknownStorage()

    /// The action to take if the target table does not exist
    enum TableNotExistOption: SwiftProtobuf.Enum, Swift.CaseIterable {
      typealias RawValue = Int
      ...
      // The compiler won't synthesize support with the UNRECOGNIZED case.
      static let allCases: [Arrow_Flight_Protocol_Sql_CommandStatementIngest.TableDefinitionOptions.TableNotExistOption] = [
        .unspecified,
        .create,
        .fail,
      ]
    ...
    enum TableExistsOption: SwiftProtobuf.Enum, Swift.CaseIterable {
      typealias RawValue = Int
      ...
      // The compiler won't synthesize support with the UNRECOGNIZED case.
      static let allCases: [Arrow_Flight_Protocol_Sql_CommandStatementIngest.TableDefinitionOptions.TableExistsOption] = [
        .unspecified,
        .fail,
        .append,
        .replace,
  ...
  fileprivate var _tableDefinitionOptions: Arrow_Flight_Protocol_Sql_CommandStatementIngest.TableDefinitionOptions? = nil
...
struct Arrow_Flight_Protocol_Sql_DoPutUpdateResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Arrow_Flight_Protocol_Sql_DoPutPreparedStatementResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var preparedStatementHandle: Data {
    get {return _preparedStatementHandle ?? Data()}
    set {_preparedStatementHandle = newValue}
  }
  /// Returns true if `preparedStatementHandle` has been explicitly set.
  var hasPreparedStatementHandle: Bool {return self._preparedStatementHandle != nil}
  /// Clears the value of `preparedStatementHandle`. Subsequent reads from it will return its default value.
  mutating func clearPreparedStatementHandle() {self._preparedStatementHandle = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _preparedStatementHandle: Data? = nil
}
...
struct Arrow_Flight_Protocol_Sql_ActionCancelQueryRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///
/// NOTE: This message was marked as deprecated in the .proto file.
struct Arrow_Flight_Protocol_Sql_ActionCancelQueryResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum CancelResult: SwiftProtobuf.Enum, Swift.CaseIterable {
    typealias RawValue = Int
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    static let allCases: [Arrow_Flight_Protocol_Sql_ActionCancelQueryResult.CancelResult] = [
      .unspecified,
      .cancelled,
      .cancelling,
      .notCancellable,
...
extension Arrow_Flight_Protocol_Sql_SqlInfo: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0FLIGHT_SQL_SERVER_NAME\0\u{1}FLIGHT_SQL_SERVER_VERSION\0\u{1}FLIGHT_SQL_SERVER_ARROW_VERSION\0\u{1}FLIGHT_SQL_SERVER_READ_ONLY\0\u{1}FLIGHT_SQL_SERVER_SQL\0\u{1}FLIGHT_SQL_SERVER_SUBSTRAIT\0\u{1}FLIGHT_SQL_SERVER_SUBSTRAIT_MIN_VERSION\0\u{1}FLIGHT_SQL_SERVER_SUBSTRAIT_MAX_VERSION\0\u{1}FLIGHT_SQL_SERVER_TRANSACTION\0\u{1}FLIGHT_SQL_SERVER_CANCEL\0\u{1}FLIGHT_SQL_SERVER_BULK_INGESTION\0\u{1}FLIGHT_SQL_SERVER_INGEST_TRANSACTIONS_SUPPORTED\0\u{2}Y\u{1}FLIGHT_SQL_SERVER_STATEMENT_TIMEOUT\0\u{1}FLIGHT_SQL_SERVER_TRANSACTION_TIMEOUT\0\u{2}O\u{6}SQL_DDL_CATALOG\0\u{1}SQL_DDL_SCHEMA\0\u{1}SQL_DDL_TABLE\0\u{1}SQL_IDENTIFIER_CASE\0\u{1}SQL_IDENTIFIER_QUOTE_CHAR\0\u{1}SQL_QUOTED_IDENTIFIER_CASE\0\u{1}SQL_ALL_TABLES_ARE_SELECTABLE\0\u{1}SQL_NULL_ORDERING\0\u{1}SQL_KEYWORDS\0\u{1}SQL_NUMERIC_FUNCTIONS\0\u{1}SQL_STRING_FUNCTIONS\0\u{1}SQL_SYSTEM_FUNCTIONS\0\u{1}SQL_DATETIME_FUNCTIONS\0\u{1}SQL_SEARCH_STRING_ESCAPE\0\u{1}SQL_EXTRA_NAME_CHARACTERS\0\u{1}SQL_SUPPORTS_COLUMN_ALIASING\0\u{1}SQL_NULL_PLUS_NULL_IS_NULL\0\u{1}SQL_SUPPORTS_CONVERT\0\u{1}SQL_SUPPORTS_TABLE_CORRELATION_NAMES\0\u{1}SQL_SUPPORTS_DIFFERENT_TABLE_CORRELATION_NAMES\0\u{1}SQL_SUPPORTS_EXPRESSIONS_IN_ORDER_BY\0\u{1}SQL_SUPPORTS_ORDER_BY_UNRELATED\0\u{1}SQL_SUPPORTED_GROUP_BY\0\u{1}SQL_SUPPORTS_LIKE_ESCAPE_CLAUSE\0\u{1}SQL_SUPPORTS_NON_NULLABLE_COLUMNS\0\u{1}SQL_SUPPORTED_GRAMMAR\0\u{1}SQL_ANSI92_SUPPORTED_LEVEL\0\u{1}SQL_SUPPORTS_INTEGRITY_ENHANCEMENT_FACILITY\0\u{1}SQL_OUTER_JOINS_SUPPORT_LEVEL\0\u{1}SQL_SCHEMA_TERM\0\u{1}SQL_PROCEDURE_TERM\0\u{1}SQL_CATALOG_TERM\0\u{1}SQL_CATALOG_AT_START\0\u{1}SQL_SCHEMAS_SUPPORTED_ACTIONS\0\u{1}SQL_CATALOGS_SUPPORTED_ACTIONS\0\u{1}SQL_SUPPORTED_POSITIONED_COMMANDS\0\u{1}SQL_SELECT_FOR_UPDATE_SUPPORTED\0\u{1}SQL_STORED_PROCEDURES_SUPPORTED\0\u{1}SQL_SUPPORTED_SUBQUERIES\0\u{1}SQL_CORRELATED_SUBQUERIES_SUPPORTED\0\u{1}SQL_SUPPORTED_UNIONS\0\u{1}SQL_MAX_BINARY_LITERAL_LENGTH\0\u{1}SQL_MAX_CHAR_LITERAL_LENGTH\0\u{1}SQL_MAX_COLUMN_NAME_LENGTH\0\u{1}SQL_MAX_COLUMNS_IN_GROUP_BY\0\u{1}SQL_MAX_COLUMNS_IN_INDEX\0\u{1}SQL_MAX_COLUMNS_IN_ORDER_BY\0\u{1}SQL_MAX_COLUMNS_IN_SELECT\0\u{1}SQL_MAX_COLUMNS_IN_TABLE\0\u{1}SQL_MAX_CONNECTIONS\0\u{1}SQL_MAX_CURSOR_NAME_LENGTH\0\u{1}SQL_MAX_INDEX_LENGTH\0\u{1}SQL_DB_SCHEMA_NAME_LENGTH\0\u{1}SQL_MAX_PROCEDURE_NAME_LENGTH\0\u{1}SQL_MAX_CATALOG_NAME_LENGTH\0\u{1}SQL_MAX_ROW_SIZE\0\u{1}SQL_MAX_ROW_SIZE_INCLUDES_BLOBS\0\u{1}SQL_MAX_STATEMENT_LENGTH\0\u{1}SQL_MAX_STATEMENTS\0\u{1}SQL_MAX_TABLE_NAME_LENGTH\0\u{1}SQL_MAX_TABLES_IN_SELECT\0\u{1}SQL_MAX_USERNAME_LENGTH\0\u{1}SQL_DEFAULT_TRANSACTION_ISOLATION\0\u{1}SQL_TRANSACTIONS_SUPPORTED\0\u{1}SQL_SUPPORTED_TRANSACTIONS_ISOLATION_LEVELS\0\u{1}SQL_DATA_DEFINITION_CAUSES_TRANSACTION_COMMIT\0\u{1}SQL_DATA_DEFINITIONS_IN_TRANSACTIONS_IGNORED\0\u{1}SQL_SUPPORTED_RESULT_SET_TYPES\0\u{1}SQL_SUPPORTED_CONCURRENCIES_FOR_RESULT_SET_UNSPECIFIED\0\u{1}SQL_SUPPORTED_CONCURRENCIES_FOR_RESULT_SET_FORWARD_ONLY\0\u{1}SQL_SUPPORTED_CONCURRENCIES_FOR_RESULT_SET_SCROLL_SENSITIVE\0\u{1}SQL_SUPPORTED_CONCURRENCIES_FOR_RESULT_SET_SCROLL_INSENSITIVE\0\u{1}SQL_BATCH_UPDATES_SUPPORTED\0\u{1}SQL_SAVEPOINTS_SUPPORTED\0\u{1}SQL_NAMED_PARAMETERS_SUPPORTED\0\u{1}SQL_LOCATORS_UPDATE_COPY\0\u{1}SQL_STORED_FUNCTIONS_USING_CALL_SYNTAX_SUPPORTED\0")
}

extension Arrow_Flight_Protocol_Sql_SqlSupportedTransaction: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_SUPPORTED_TRANSACTION_NONE\0\u{1}SQL_SUPPORTED_TRANSACTION_TRANSACTION\0\u{1}SQL_SUPPORTED_TRANSACTION_SAVEPOINT\0")
}

extension Arrow_Flight_Protocol_Sql_SqlSupportedCaseSensitivity: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_CASE_SENSITIVITY_UNKNOWN\0\u{1}SQL_CASE_SENSITIVITY_CASE_INSENSITIVE\0\u{1}SQL_CASE_SENSITIVITY_UPPERCASE\0\u{1}SQL_CASE_SENSITIVITY_LOWERCASE\0")
}

extension Arrow_Flight_Protocol_Sql_SqlNullOrdering: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_NULLS_SORTED_HIGH\0\u{1}SQL_NULLS_SORTED_LOW\0\u{1}SQL_NULLS_SORTED_AT_START\0\u{1}SQL_NULLS_SORTED_AT_END\0")
}

extension Arrow_Flight_Protocol_Sql_SupportedSqlGrammar: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_MINIMUM_GRAMMAR\0\u{1}SQL_CORE_GRAMMAR\0\u{1}SQL_EXTENDED_GRAMMAR\0")
}

extension Arrow_Flight_Protocol_Sql_SupportedAnsi92SqlGrammarLevel: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0ANSI92_ENTRY_SQL\0\u{1}ANSI92_INTERMEDIATE_SQL\0\u{1}ANSI92_FULL_SQL\0")
}

extension Arrow_Flight_Protocol_Sql_SqlOuterJoinsSupportLevel: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_JOINS_UNSUPPORTED\0\u{1}SQL_LIMITED_OUTER_JOINS\0\u{1}SQL_FULL_OUTER_JOINS\0")
}

extension Arrow_Flight_Protocol_Sql_SqlSupportedGroupBy: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_GROUP_BY_UNRELATED\0\u{1}SQL_GROUP_BY_BEYOND_SELECT\0")
}

extension Arrow_Flight_Protocol_Sql_SqlSupportedElementActions: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_ELEMENT_IN_PROCEDURE_CALLS\0\u{1}SQL_ELEMENT_IN_INDEX_DEFINITIONS\0\u{1}SQL_ELEMENT_IN_PRIVILEGE_DEFINITIONS\0")
}

extension Arrow_Flight_Protocol_Sql_SqlSupportedPositionedCommands: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_POSITIONED_DELETE\0\u{1}SQL_POSITIONED_UPDATE\0")
}

extension Arrow_Flight_Protocol_Sql_SqlSupportedSubqueries: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_SUBQUERIES_IN_COMPARISONS\0\u{1}SQL_SUBQUERIES_IN_EXISTS\0\u{1}SQL_SUBQUERIES_IN_INS\0\u{1}SQL_SUBQUERIES_IN_QUANTIFIEDS\0")
}

extension Arrow_Flight_Protocol_Sql_SqlSupportedUnions: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_UNION\0\u{1}SQL_UNION_ALL\0")
}

extension Arrow_Flight_Protocol_Sql_SqlTransactionIsolationLevel: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_TRANSACTION_NONE\0\u{1}SQL_TRANSACTION_READ_UNCOMMITTED\0\u{1}SQL_TRANSACTION_READ_COMMITTED\0\u{1}SQL_TRANSACTION_REPEATABLE_READ\0\u{1}SQL_TRANSACTION_SERIALIZABLE\0")
}

extension Arrow_Flight_Protocol_Sql_SqlSupportedTransactions: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_TRANSACTION_UNSPECIFIED\0\u{1}SQL_DATA_DEFINITION_TRANSACTIONS\0\u{1}SQL_DATA_MANIPULATION_TRANSACTIONS\0")
}

extension Arrow_Flight_Protocol_Sql_SqlSupportedResultSetType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_RESULT_SET_TYPE_UNSPECIFIED\0\u{1}SQL_RESULT_SET_TYPE_FORWARD_ONLY\0\u{1}SQL_RESULT_SET_TYPE_SCROLL_INSENSITIVE\0\u{1}SQL_RESULT_SET_TYPE_SCROLL_SENSITIVE\0")
}

extension Arrow_Flight_Protocol_Sql_SqlSupportedResultSetConcurrency: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_RESULT_SET_CONCURRENCY_UNSPECIFIED\0\u{1}SQL_RESULT_SET_CONCURRENCY_READ_ONLY\0\u{1}SQL_RESULT_SET_CONCURRENCY_UPDATABLE\0")
}

extension Arrow_Flight_Protocol_Sql_SqlSupportsConvert: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SQL_CONVERT_BIGINT\0\u{1}SQL_CONVERT_BINARY\0\u{1}SQL_CONVERT_BIT\0\u{1}SQL_CONVERT_CHAR\0\u{1}SQL_CONVERT_DATE\0\u{1}SQL_CONVERT_DECIMAL\0\u{1}SQL_CONVERT_FLOAT\0\u{1}SQL_CONVERT_INTEGER\0\u{1}SQL_CONVERT_INTERVAL_DAY_TIME\0\u{1}SQL_CONVERT_INTERVAL_YEAR_MONTH\0\u{1}SQL_CONVERT_LONGVARBINARY\0\u{1}SQL_CONVERT_LONGVARCHAR\0\u{1}SQL_CONVERT_NUMERIC\0\u{1}SQL_CONVERT_REAL\0\u{1}SQL_CONVERT_SMALLINT\0\u{1}SQL_CONVERT_TIME\0\u{1}SQL_CONVERT_TIMESTAMP\0\u{1}SQL_CONVERT_TINYINT\0\u{1}SQL_CONVERT_VARBINARY\0\u{1}SQL_CONVERT_VARCHAR\0")
}

extension Arrow_Flight_Protocol_Sql_XdbcDataType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}w\u{7f}\u{7f}\u{7f}\u{7f}\u{3}XDBC_WVARCHAR\0\u{1}XDBC_WCHAR\0\u{1}XDBC_BIT\0\u{1}XDBC_TINYINT\0\u{1}XDBC_BIGINT\0\u{1}XDBC_LONGVARBINARY\0\u{1}XDBC_VARBINARY\0\u{1}XDBC_BINARY\0\u{1}XDBC_LONGVARCHAR\0\u{1}XDBC_UNKNOWN_TYPE\0\u{1}XDBC_CHAR\0\u{1}XDBC_NUMERIC\0\u{1}XDBC_DECIMAL\0\u{1}XDBC_INTEGER\0\u{1}XDBC_SMALLINT\0\u{1}XDBC_FLOAT\0\u{1}XDBC_REAL\0\u{1}XDBC_DOUBLE\0\u{1}XDBC_DATETIME\0\u{1}XDBC_INTERVAL\0\u{2}\u{2}XDBC_VARCHAR\0\u{2}O\u{1}XDBC_DATE\0\u{1}XDBC_TIME\0\u{1}XDBC_TIMESTAMP\0")
}

extension Arrow_Flight_Protocol_Sql_XdbcDatetimeSubcode: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0XDBC_SUBCODE_UNKNOWN\0\u{9}XDBC_SUBCODE_YEAR\0\u{1}XDBC_SUBCODE_DATE\0\u{9}XDBC_SUBCODE_TIME\0\u{1}XDBC_SUBCODE_MONTH\0\u{9}XDBC_SUBCODE_TIMESTAMP\0\u{1}XDBC_SUBCODE_DAY\0\u{9}XDBC_SUBCODE_TIME_WITH_TIMEZONE\0\u{1}XDBC_SUBCODE_HOUR\0\u{9}XDBC_SUBCODE_TIMESTAMP_WITH_TIMEZONE\0\u{1}XDBC_SUBCODE_MINUTE\0\u{1}XDBC_SUBCODE_SECOND\0\u{1}XDBC_SUBCODE_YEAR_TO_MONTH\0\u{1}XDBC_SUBCODE_DAY_TO_HOUR\0\u{1}XDBC_SUBCODE_DAY_TO_MINUTE\0\u{1}XDBC_SUBCODE_DAY_TO_SECOND\0\u{1}XDBC_SUBCODE_HOUR_TO_MINUTE\0\u{1}XDBC_SUBCODE_HOUR_TO_SECOND\0\u{1}XDBC_SUBCODE_MINUTE_TO_SECOND\0\u{2}X\u{1}XDBC_SUBCODE_INTERVAL_YEAR\0\u{1}XDBC_SUBCODE_INTERVAL_MONTH\0\u{1}XDBC_SUBCODE_INTERVAL_DAY\0\u{1}XDBC_SUBCODE_INTERVAL_HOUR\0\u{1}XDBC_SUBCODE_INTERVAL_MINUTE\0\u{1}XDBC_SUBCODE_INTERVAL_SECOND\0\u{1}XDBC_SUBCODE_INTERVAL_YEAR_TO_MONTH\0\u{1}XDBC_SUBCODE_INTERVAL_DAY_TO_HOUR\0\u{1}XDBC_SUBCODE_INTERVAL_DAY_TO_MINUTE\0\u{1}XDBC_SUBCODE_INTERVAL_DAY_TO_SECOND\0\u{1}XDBC_SUBCODE_INTERVAL_HOUR_TO_MINUTE\0\u{1}XDBC_SUBCODE_INTERVAL_HOUR_TO_SECOND\0\u{1}XDBC_SUBCODE_INTERVAL_MINUTE_TO_SECOND\0")
}

extension Arrow_Flight_Protocol_Sql_Nullable: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NULLABILITY_NO_NULLS\0\u{1}NULLABILITY_NULLABLE\0\u{1}NULLABILITY_UNKNOWN\0")
}

extension Arrow_Flight_Protocol_Sql_Searchable: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SEARCHABLE_NONE\0\u{1}SEARCHABLE_CHAR\0\u{1}SEARCHABLE_BASIC\0\u{1}SEARCHABLE_FULL\0")
}

extension Arrow_Flight_Protocol_Sql_UpdateDeleteRules: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0CASCADE\0\u{1}RESTRICT\0\u{1}SET_NULL\0\u{1}NO_ACTION\0\u{1}SET_DEFAULT\0")
}
...
extension Arrow_Flight_Protocol_Sql_CommandGetXdbcTypeInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}data_type\0")
...
extension Arrow_Flight_Protocol_Sql_CommandGetDbSchemas: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}catalog\0\u{3}db_schema_filter_pattern\0")
...
extension Arrow_Flight_Protocol_Sql_CommandGetTables: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}catalog\0\u{3}db_schema_filter_pattern\0\u{3}table_name_filter_pattern\0\u{3}table_types\0\u{3}include_schema\0")
...
extension Arrow_Flight_Protocol_Sql_CommandGetPrimaryKeys: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}catalog\0\u{3}db_schema\0\u{1}table\0")
...
extension Arrow_Flight_Protocol_Sql_CommandGetCrossReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}pk_catalog\0\u{3}pk_db_schema\0\u{3}pk_table\0\u{3}fk_catalog\0\u{3}fk_db_schema\0\u{3}fk_table\0")
...
extension Arrow_Flight_Protocol_Sql_ActionCreatePreparedStatementRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}query\0\u{3}transaction_id\0")
...
extension Arrow_Flight_Protocol_Sql_SubstraitPlan: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}plan\0\u{1}version\0")
...
extension Arrow_Flight_Protocol_Sql_ActionCreatePreparedSubstraitPlanRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}plan\0\u{3}transaction_id\0")
...
extension Arrow_Flight_Protocol_Sql_ActionCreatePreparedStatementResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}prepared_statement_handle\0\u{3}dataset_schema\0\u{3}parameter_schema\0")
...
extension Arrow_Flight_Protocol_Sql_ActionClosePreparedStatementRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}prepared_statement_handle\0")
...
extension Arrow_Flight_Protocol_Sql_ActionBeginSavepointRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}transaction_id\0\u{1}name\0")
...
extension Arrow_Flight_Protocol_Sql_ActionBeginSavepointResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}savepoint_id\0")
...
extension Arrow_Flight_Protocol_Sql_ActionEndTransactionRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}transaction_id\0\u{1}action\0")
...
extension Arrow_Flight_Protocol_Sql_ActionEndTransactionRequest.EndTransaction: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0END_TRANSACTION_UNSPECIFIED\0\u{1}END_TRANSACTION_COMMIT\0\u{1}END_TRANSACTION_ROLLBACK\0")
}
...
extension Arrow_Flight_Protocol_Sql_ActionEndSavepointRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}savepoint_id\0\u{1}action\0")
...
extension Arrow_Flight_Protocol_Sql_ActionEndSavepointRequest.EndSavepoint: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0END_SAVEPOINT_UNSPECIFIED\0\u{1}END_SAVEPOINT_RELEASE\0\u{1}END_SAVEPOINT_ROLLBACK\0")
}
...
extension Arrow_Flight_Protocol_Sql_TicketStatementQuery: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}statement_handle\0")
...
extension Arrow_Flight_Protocol_Sql_CommandStatementIngest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CommandStatementIngest"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}table_definition_options\0\u{1}table\0\u{1}schema\0\u{1}catalog\0\u{1}temporary\0\u{3}transaction_id\0\u{2}b\u{f}options\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._tableDefinitionOptions) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.table) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self._schema) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self._catalog) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self.temporary) }()
      case 6: try { try decoder.decodeSingularBytesField(value: &self._transactionID) }()
      case 1000: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufString>.self, value: &self.options) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._tableDefinitionOptions {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    if !self.table.isEmpty {
    ...
    if !self.options.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufString>.self, value: self.options, fieldNumber: 1000)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Arrow_Flight_Protocol_Sql_CommandStatementIngest, rhs: Arrow_Flight_Protocol_Sql_CommandStatementIngest) -> Bool {
    if lhs._tableDefinitionOptions != rhs._tableDefinitionOptions {return false}
    if lhs.table != rhs.table {return false}
...
extension Arrow_Flight_Protocol_Sql_CommandStatementIngest.TableDefinitionOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Arrow_Flight_Protocol_Sql_CommandStatementIngest.protoMessageName + ".TableDefinitionOptions"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}if_not_exist\0\u{3}if_exists\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.ifNotExist) }()
      case 2: try { try decoder.decodeSingularEnumField(value: &self.ifExists) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.ifNotExist != .unspecified {
      try visitor.visitSingularEnumField(value: self.ifNotExist, fieldNumber: 1)
    }
    if self.ifExists != .unspecified {
      try visitor.visitSingularEnumField(value: self.ifExists, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Arrow_Flight_Protocol_Sql_CommandStatementIngest.TableDefinitionOptions, rhs: Arrow_Flight_Protocol_Sql_CommandStatementIngest.TableDefinitionOptions) -> Bool {
    if lhs.ifNotExist != rhs.ifNotExist {return false}
...
extension Arrow_Flight_Protocol_Sql_CommandStatementIngest.TableDefinitionOptions.TableNotExistOption: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0TABLE_NOT_EXIST_OPTION_UNSPECIFIED\0\u{1}TABLE_NOT_EXIST_OPTION_CREATE\0\u{1}TABLE_NOT_EXIST_OPTION_FAIL\0")
}

extension Arrow_Flight_Protocol_Sql_CommandStatementIngest.TableDefinitionOptions.TableExistsOption: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0TABLE_EXISTS_OPTION_UNSPECIFIED\0\u{1}TABLE_EXISTS_OPTION_FAIL\0\u{1}TABLE_EXISTS_OPTION_APPEND\0\u{1}TABLE_EXISTS_OPTION_REPLACE\0")
}
...
extension Arrow_Flight_Protocol_Sql_DoPutUpdateResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}record_count\0")
...
extension Arrow_Flight_Protocol_Sql_DoPutPreparedStatementResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".DoPutPreparedStatementResult"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}prepared_statement_handle\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBytesField(value: &self._preparedStatementHandle) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._preparedStatementHandle {
      try visitor.visitSingularBytesField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Arrow_Flight_Protocol_Sql_DoPutPreparedStatementResult, rhs: Arrow_Flight_Protocol_Sql_DoPutPreparedStatementResult) -> Bool {
    if lhs._preparedStatementHandle != rhs._preparedStatementHandle {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Arrow_Flight_Protocol_Sql_ActionCancelQueryResult.CancelResult: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0CANCEL_RESULT_UNSPECIFIED\0\u{1}CANCEL_RESULT_CANCELLED\0\u{1}CANCEL_RESULT_CANCELLING\0\u{1}CANCEL_RESULT_NOT_CANCELLABLE\0")
}
