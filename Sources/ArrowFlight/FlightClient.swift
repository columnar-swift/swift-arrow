...
public class FlightClient {
  ...
  public func doAction(
    _ action: FlightAction, closure: (FlightResult) throws -> Void
  ) async throws {
  ...
  public func getSchema(_ descriptor: FlightDescriptor) async throws
    -> FlightSchemaResult
  {
  ...
  public func doPut(
    ...
    try await writeBatches(
      putCall.requestStream, descriptor: descriptor,
  ...
  public func doPut(
    _ flightData: FlightData, closure: (FlightPutResult) throws -> Void
  ) async throws {
    let putCall = client.makeDoPutCall()
  ...
  public func doExchange(
    ...
    try await writeBatches(
      exchangeCall.requestStream, descriptor: descriptor,
      recordBatches: recordBatches)
    try closure(try await readMessages(exchangeCall.responseStream))
  }

  public func doExchange(
    flightData: FlightData, closure: (FlightData) throws -> Void
  ) async throws {
    let exchangeCall = client.makeDoExchangeCall()
