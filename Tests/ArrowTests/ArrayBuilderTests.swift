...
struct ArrayBuilderTests {
  ...
  @Test func loadArrayBuilders() throws {
    #expect(throws: Never.self) {
      let _ = try ArrowArrayBuilders.loadBuilder(Int8.self)
      let _ = try ArrowArrayBuilders.loadBuilder(Int16.self)
      let _ = try ArrowArrayBuilders.loadBuilder(Int32.self)
      let _ = try ArrowArrayBuilders.loadBuilder(Int64.self)
      let _ = try ArrowArrayBuilders.loadBuilder(UInt8.self)
      let _ = try ArrowArrayBuilders.loadBuilder(UInt16.self)
      let _ = try ArrowArrayBuilders.loadBuilder(UInt32.self)
      let _ = try ArrowArrayBuilders.loadBuilder(UInt64.self)
      let _ = try ArrowArrayBuilders.loadBuilder(Float.self)
      let _ = try ArrowArrayBuilders.loadBuilder(Double.self)
      let _ = try ArrowArrayBuilders.loadBuilder(Date.self)
      let _ = try ArrowArrayBuilders.loadBuilder(Bool.self)
      let _ = try ArrowArrayBuilders.loadBuilder(Int8?.self)
      let _ = try ArrowArrayBuilders.loadBuilder(Int16?.self)
      let _ = try ArrowArrayBuilders.loadBuilder(Int32?.self)
      let _ = try ArrowArrayBuilders.loadBuilder(Int64?.self)
    ...
    #expect(throws: ArrowError.self) {
      let _ = try ArrowArrayBuilders.loadBuilder(Int.self)
      let _ = try ArrowArrayBuilders.loadBuilder(UInt.self)
      let _ = try ArrowArrayBuilders.loadBuilder(Int?.self)
      let _ = try ArrowArrayBuilders.loadBuilder(UInt?.self)
    }
  }
